...
5. **`sort`** - пузырьковая сортировка
   - [Исходный код и тест](/python/golden/sort.yml)
   - сортировка массива положительных чисел получаемых от пользователя (length-prefixed)

6. **`prob1`** - алгоритм согласно варианту
